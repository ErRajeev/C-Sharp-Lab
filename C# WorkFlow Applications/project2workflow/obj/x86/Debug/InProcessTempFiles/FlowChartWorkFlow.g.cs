...
namespace project2workflow {
    ...
    public partial class FlowChartWorkFlow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(FlowChartWorkFlow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(FlowChartWorkFlow));
        ...
        private string FindResource() {
            string[] resources = typeof(FlowChartWorkFlow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".FlowChartWorkFlow.g.xaml") || resource.Equals("FlowChartWorkFlow.g.xaml"))) {
                    return resource;
                }
            }
