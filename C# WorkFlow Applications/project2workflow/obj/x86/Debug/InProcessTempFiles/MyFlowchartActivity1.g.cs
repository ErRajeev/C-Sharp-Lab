...
namespace project2workflow {
    ...
    public partial class MyFlowchartActivity1 : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(MyFlowchartActivity1).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(MyFlowchartActivity1));
        ...
        private string FindResource() {
            string[] resources = typeof(MyFlowchartActivity1).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".MyFlowchartActivity1.g.xaml") || resource.Equals("MyFlowchartActivity1.g.xaml"))) {
                    return resource;
                }
            }
