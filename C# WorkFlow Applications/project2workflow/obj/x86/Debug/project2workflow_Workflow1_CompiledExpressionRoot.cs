namespace project2workflow {
    ...
    #line 13 "S:\Languages\C#\project2workflow\Workflow1.xaml"
    using System;
    
    #line default
    #line hidden
    
    #line 1 "S:\Languages\C#\project2workflow\Workflow1.xaml"
    using System.Collections;
    
    #line default
    #line hidden
    
    #line 14 "S:\Languages\C#\project2workflow\Workflow1.xaml"
    ...
    #line 15 "S:\Languages\C#\project2workflow\Workflow1.xaml"
    using System.Data;
    
    #line default
    #line hidden
    
    #line 16 "S:\Languages\C#\project2workflow\Workflow1.xaml"
    using System.Linq;
    
    #line default
    #line hidden
    
    #line 17 "S:\Languages\C#\project2workflow\Workflow1.xaml"
    using System.Text;
    ...
    public partial class Workflow1 : System.Activities.XamlIntegration.ICompiledExpressionRoot {
        ...
        public bool CanExecuteExpression(string expressionText, bool isReference, System.Collections.Generic.IList<System.Activities.LocationReference> locations, out int expressionId) {
            if (((isReference == false) 
                        && ((expressionText == "\"Hello Rajeev! Welcome to workflow \" + DateTime.Now.ToString()") 
        ...
        private class Workflow1_TypedDataContext1_ForReadOnly : Workflow1_TypedDataContext0_ForReadOnly {
            ...
            internal System.Linq.Expressions.Expression @__Expr0GetTree() {
                ...
                #line 39 "S:\LANGUAGES\C#\PROJECT2WORKFLOW\WORKFLOW1.XAML"
                System.Linq.Expressions.Expression<System.Func<string>> expression = () => 
        "Hello Rajeev! Welcome to workflow " + DateTime.Now.ToString();
        ...
        "Hello Rajeev! Welcome to workflow " + DateTime.Now.ToString();
            ...
            internal System.Linq.Expressions.Expression @__Expr1GetTree() {
                ...
                #line 45 "S:\LANGUAGES\C#\PROJECT2WORKFLOW\WORKFLOW1.XAML"
                System.Linq.Expressions.Expression<System.Func<string>> expression = () => 
        "Hello Rajeev! Welcome to workflow " + DateTime.Now.ToString();
